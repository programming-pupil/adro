...
| Open-source license/SBOM/release traceability | implemented | push/PR supply-chain gate plus signed-manifest checks; publishing still requires a clean version tag and release key |
