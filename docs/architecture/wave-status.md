...
Production deployment still requires configuring the included adapter boundaries
with an organization’s Multica, Git, CI, deployment, identity, secrets and
observability systems. The local profile never claims that an external system
