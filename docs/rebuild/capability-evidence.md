...
| EventStore port | dual-backend experimental | `ports/eventstore/eventstore.go`, `adapters/eventstore/sqlite`, `adapters/eventstore/postgres` | Shared CAS, same-key concurrency, idempotency, atomicity, fencing, restart, subscription, tenant and corruption conformance; full migration-chain and PostgreSQL backup/restore fingerprint | ADR-0001, ADR-0004, ADR-0005 | Application shadow write, migration crash/resume, tail repair, scoped reads and divergence evidence |
